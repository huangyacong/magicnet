...
pcLogName, iSocketTimeOut, iMaxConnect, iGatePort, iSvrPort = "gate", 60*1000, 10000, 8888, 6666
result = magicnet.GateInit(pcLogName, iSocketTimeOut, iMaxConnect, iGatePort, iSvrPort, 0)

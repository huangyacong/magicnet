...
#define MAGICNET_TO_SVR_REG_RET 0
#define MAGICNET_TO_SVR_CLIENT_CONNECT 1
#define MAGICNET_TO_SVR_CLIENT_DISCONNECT 2
#define MAGICNET_TO_SVR_RECV_DATA_FROM_SVR 3
#define MAGICNET_TO_SVR_RECV_DATA_FROM_CLIENT 4
